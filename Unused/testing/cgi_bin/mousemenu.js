...
showmenu:function(menuid){
	...
	var posx=menu.anchorobj._offsets.left + (menu.orientation=="lr"? this.dimensions.anchorw : 0) //base x pos
        // Explorer and Firefox render the menu in different spots (in Y), so adjust.
	if (window.attachEvent)
		var posy=menu.anchorobj._offsets.top + this.dimensions.anchorh - (menu.orientation=="lr"? this.dimensions.anchorh : 0)
	else {
		if (menu.orientation=="lr")
			var posy=menu.anchorobj._offsets.top - this.dimensions.anchorh - this.dimensions.anchorh
		else
